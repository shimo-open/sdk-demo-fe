 ...
 * 2 - 页脚
 */
export declare type DocumentPos = 0 | 1 | 2;
/**
 * 水平对齐方式
 * 0 - 右对齐
 * 1 - 左对齐
 * 2 - 居中对齐
 */
export declare type HorizontalAlignment = 0 | 1 | 2;
/** 事件名 */
export declare type Events = 'selectionEnded' | 'documentChanged' | 'commentClicked' | 'FullRecalculated';
